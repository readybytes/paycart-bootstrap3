...
<div class="well clearfix">
		...
		<div class="form-group clearfix">
        	<div class="control-label">
          	...
          	<div>
		        <input type="text"  size="20" id="rb-processor-mes-card-number" class="form-control validate-rb-credit-card" name="payment_data[card_number]" required="true" autocomplete="off"/>
        	</div>
        ...
        <div class="form-group clearfix">
			...
			<div class="row">
				<div class= "col-xs-6 ">				
		            <select name="payment_data[exp_month]" class="form-control input-small validate-rb-exp-date "  
			    ...
			    <div class=" col-xs-4">
		            <select name="payment_data[exp_year]" class="form-control input-small validate-rb-exp-date" 
       	...
       	<div class="form-group clearfix">
	        ...
	        <div>
	        	<input type="text" size="4" name="payment_data[cvv2]" class="required form-control input-small validate-rb-cvc-length" id="rb-processor-mes-cvn-number" data-rb-validate='#rb-processor-mes-card-number'  required="true"  autocomplete="off"/>
	            <span class="add-on">
	            	<?php 
         ...
         <div  class="form-group clearfix" >
            ...
            <div>
          		<textarea class="form-control required " name="payment_data[address]" id="rb-processor-mes-address" value=""></textarea>
            </div>
		...
		<div class="form-group clearfix" >
	        ...
	        <div>
	        	<input type="text" class="form-control required " id="rb-processor-mes-zip" name="payment_data[zip]" value=""></input>
	        </div>
