...
<div class="well ">
		...
		<span class="payment-errors hide"></span>
		    <div class="form-group" >
		        ...
		        <div >
					<select name="cc_type" id ="rb_ecommerce_processor_eway_cc_type" class="form-control" >
				...
				<span for="rb_ecommerce_processor_eway_cc_type" class="rb-error hide"><?php echo  JText::_('PLG_RB_ECOMMERCEPROCESSOR_EWAY_ERROR_CC_TYPE_NOT_VALID'); ?></span>
 		 ...
 		 <div class="form-group" >
		        ...
		        <div >
		       		 <input type="text"  size="20" class="form-control required" name="payment_data[card_name]"  id ="rb-processor-eway-card-name"/>
		        </div>
		 ...
		 <div class="form-group" >
		         ...
		         <div >
		       		 <input type="text"  size="20" id="rb-processor-eway-card-number" class="form-control validate-rb-credit-card required" name="payment_data[card_number]" autocomplete="off"/>
		       	 </div>	 
		...
		<span id="rb-processor-eway-card-expiry-error" class="col-md-12 col-xs-12 rb-error hide"><?php echo  JText::_('PLG_RB_ECOMMERCEPROCESSOR_EWAY_ERROR_EXPIRY_DATE_NOT_VALID'); ?> </span>	
        </div>
       	...
       	<div class="form-group clearfix" >
		        ...
		        <div class="input-group">		        
		        	<input type="text" size="4" name="payment_data[card_code]" class="form-control validate-rb-cvc-length" id="rb-processor-eway-cvc-number" data-rb-validate='#rb-processor-eway-card-number'  required="true" autocomplete="off"/>
	    ...
	    <div class="form-group clearfix" >
		        ...
		        <div >
		          	<input type="text" class="form-control required " name="payment_data[company]" id="rb-processor-eway-company" value=""></input>
		        </div>
          ...
          <div class="form-group clearfix" >
             	<div class="control-label"> 
          			<label for="rb-processor-eway-first_name">
			      		<?php echo JText::_('PLG_RB_ECOMMERCEPROCESSOR_EWAY_FORM_FIRST_NAME_LABEL').'/'.JText::_('PLG_RB_ECOMMERCEPROCESSOR_EWAY_FORM_TITLE_LABEL');?>
					</label>
				</div>
		       
		        <div class="row"> 
		        	<div class="col-xs-3">
			        	<select name="name_title" id="rb-processor-eway-name_title" class="form-control" >
		             ...
		             <div class="col-xs-9">
		          	<input type="text" class="form-control required " name="payment_data[first_name]" id="rb-processor-eway-first_name" value=""></input>
		          	</div>
		        </div>
         ...
         <div class="form-group clearfix" >
		        ...
		        <div >
		          	<input type="text" class="form-control required " name="payment_data[last_name]" id="rb-processor-eway-last_name" value=""></input>
		        </div>
		  ...
		  <div class="form-group" >
		          ...
		          <div >
		          	<input type="email" class="form-control required " name="payment_data[email]" id="rb-processor-eway-email" value=""></input>
		          </div>
         ...
         <div class="form-group" >
		          ...
		          <div >
		          	<input type="text" class="form-control required " name="payment_data[phone]" id="rb-processor-eway-phone" value=""></input>
		          </div>
         ...
         <div class="form-group" >
          	...
          	<div >
          		<input type="text" class="form-control required " name="payment_data[mobile]" id="rb-processor-eway-mobile" value=""></input>
          	</div>
        ...
        <div class="form-group" >
	          ...
	          <div >
	          	<input type="text" class="form-control required " name="payment_data[fax]" id="rb-processor-eway-fax" value=""></input>
	          </div>
         ...
         <div class="form-group" >
		          ...
		          <div >
		          	<textarea  class="form-control required " name="payment_data[address]" id="rb-processor-eway-address"></textarea>
		          </div>
          ...
          <div class="form-group" >
	           <div class="control-label">
	            ...
	            <div >
		  			<?php echo PaycartHtmlCountry::getList("payment_data[country]", '', "rb-processor-eway-country", array('class' => 'form-control required')); ?>
		        </div>
        ...
        <div class="form-group" >
	           <div class="control-label">
		        ...
		        <div >
		          	<input type="text" class="form-control required " name="payment_data[state]" id="rb-processor-eway-state" value=""></input>
		        </div>
        ...
        <div class="form-group" >
	          ...
	          <div >
	          	<input type="text" class="form-control required " name="payment_data[city]" id="rb-processor-eway-city" value=""></input>
	          </div>
        ...
        <div class="form-group" >
          ...
          <div >
          	...
          	<input type="text" class="form-control required " name="payment_data[zip]" id="rb-processor-eway-zip" value=""></input>
          </div>
