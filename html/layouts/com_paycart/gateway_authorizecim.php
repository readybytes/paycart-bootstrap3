...
<div class="well clearfix">
		...
		<div class="form-group">
        	<div class="control-label">
          	...
          	<div>
		        <input type="text"  size="20" id="rb-processor-authorizecim-card-number" class="form-control validate-rb-credit-card" name="payment_data[card_number]" required="true" autocomplete="off"/>
        	</div>
 	    ...
 	    <div class="form-group clearfix">
       	...
       	<div class="form-group clearfix">
	        ...
	        <div class="input-group">
	        	<input type="text" size="4" name="payment_data[card_code]" class="required form-control validate-rb-cvc-length" id="rb-processor-authorizecim-cvc-number" data-rb-validate='#rb-processor-authorizecim-card-number'  required="true"  autocomplete="off"/>
        ...
        <div class="form-group">
	        ...
	        <div>
	          	<input type="text" class="form-control required " name="payment_data[first_name]" id="rb-processor-authorizecim-first_name" value=""></input>
	        </div> 	        
         ...
         <div class="form-group">
	            ...
	            <div>
	          		<input type="text" class="form-control required "  id="rb-processor-authorizecim-last_name" name="payment_data[last_name]" value=""></input>
	           </div> 
         ...
         <div class="form-group">
	         ...
	         <div>
	          	<input type="text" class="form-control required " name="payment_data[company]" id="rb-processor-authorizecim-company" value=""></input>
	         </div>
		...
		<div class="form-group">
	        ...
	        <div>
	          		<input type="email" class="form-control required validate-email" name="payment_data[email]" id="rb-processor-authorizecim-email" value=""></input>
	        </div>
        ...
        <div class="form-group" >
	          ...
	          <div>
	          	<input type="text" class="form-control required " name="payment_data[mobile]" id="rb-processor-authorizecim-mobile" value=""></input>
	          </div>
         ...
         <div  class="form-group" >
            ...
            <div>
          		<textarea class="form-control required " name="payment_data[address]" id="rb-processor-authorizecim-address" value=""></textarea>
            </div>
	        ...
	        <span for="rb-processor-authorizecim-address" class="rb-error hide"><?php echo  JText::_('PLG_RB_ECOMMERCEPROCESSOR_AUTHORIZECIM_ERROR_VALIDATION_REQUIRED'); ?></span>  
             ...
             <div class="form-group" >
             	<div class="control-label">
		          ...
		          <div>
		  			<?php echo PaycartHtmlCountry::getList("payment_data[country]", '', "rb-processor-authorizecim-country", array('class' => 'form-control required')); ?>
		          </div>
          ...
          <div class="form-group" >
	          ...
	          <div>
	          	<input type="text" class="form-control required " id="rb-processor-authorizecim-state" name="payment_data[state]" value=""></input>
	          </div>
         ...
         <div class="form-group" >
	            ...
	            <div>
	           		<input type="text" class="form-control required " name="payment_data[city]" id="rb-processor-authorizecim-city" value=""></input>
	          	</div>
		 ...
		 <div class="form-group" >
             <div class="control-label">
	          ...
	          <div>
	          	  <input type="text" class="form-control required " id="rb-processor-authorizecim-zip" name="payment_data[zip]" value=""></input>
	          </div>
