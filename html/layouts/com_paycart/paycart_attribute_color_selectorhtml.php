...
?>
<div>
	<select id="pc-attr-<?php echo $attributeId?>" name="attributes[<?php echo $attributeId?>]" onChange = "paycart.product.selector.onChange(this)" class="form-control pull-left">
