...
<div class="well clearfix">
		...
		<fieldset>
			...
			<div class="form-group">
			    ...
			    <div>		
			    	<input type="text"  size="20" id="rb-processor-authorizeaim-card-number" class="form-control validate-rb-credit-card" name="payment_data[card_number]" required="true" autocomplete="off"/>
			    </div>	        	
	 	    ...
	 	    <div class="form-group clearfix">
				...
				<div class="row">
					<div class= "col-xs-6 ">				
			            <select name="payment_data[expiration_month]" class="form-control input-small validate-rb-exp-date "  
				    ...
				    <div class=" col-xs-4">
			            <select name="payment_data[expiration_year]" class="form-control input-small validate-rb-exp-date" 
	       	...
	       	<div class="form-group clearfix">
		        ...
		        <div>
		        	<input type="text" size="4" name="payment_data[card_code]" class="required form-control input-small validate-rb-cvc-length" id="rb-processor-authorizeaim-cvc-number" data-rb-validate='#rb-processor-authorizeaim-card-number'  required="true"  autocomplete="off"/>
   		...
   		<fieldset>
	        ...
	        <div class="form-group">
		        ...
		        <div>
		          	<input type="text" class="form-control" name="payment_data[first_name]" id="rb-processor-authorizeaim-first_name" value=""></input>
		        </div> 	        
	        ...
	        <div class="form-group">
	            ...
	            <div>
	          		<input type="text" class="form-control"  id="rb-processor-authorizeaim-last_name" name="payment_data[last_name]" value=""></input>
	           	</div> 
	        ...
	        <div class="form-group">
		        ...
		        <div>
		         	<input type="text" class="form-control" name="payment_data[company]" id="rb-processor-authorizeaim-company" value=""></input>
		        </div>		         
			...
			<div class="form-group">
		        ...
		        <div>
		          	<input type="email" class="form-control  validate-email" name="payment_data[email]" id="rb-processor-authorizeaim-email" value=""></input>
		        </div>
	        ...
	        <div class="form-group">
	          ...
	          <div>
	          		<input type="text" class="form-control" name="payment_data[mobile]" id="rb-processor-authorizeaim-mobile" value=""></input>
	          </div>
	        ...
	        <div class="form-group">
	            ...
	            <div>
	          		<textarea class="form-control" name="payment_data[address]" id="rb-processor-authorizeaim-address" value=""></textarea>
	            </div>		         
	        ...
	        <div class="form-group">
	            ...
	            <div>
	           		<input type="text" class="form-control" name="payment_data[city]" id="rb-processor-authorizeaim-city" value=""></input>
	          	</div>
	        ...
	        <div class="form-group">
		        ...
		        <div>
		          	<input type="text" class="form-control" id="rb-processor-authorizeaim-state" name="payment_data[state]" value=""></input>
		        </div>
	        ...
	        <div class="form-group">
	             <div class="control-label">
		          ...
		          <div>
		          	  <input type="text" class="form-control" id="rb-processor-authorizeaim-zip" name="payment_data[zip]" value=""></input>
		          </div>
            ...
            <div class="form-group">
		        ...
		        <div>
		  			<?php echo Rb_EcommerceHtmlCountries::getList("payment_data[country]", '', "rb-processor-authorizeaim-country", array('class' => 'form-control required')); ?>
		        </div>
