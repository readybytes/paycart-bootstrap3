...
<div class="well clearfix ">
		...
		<span class="payment-errors hide"></span>
			 ...
			 <div class="form-group">
		        ...
		        <div>
		        	<input type="text"  size="20" id="rb-processor-paypalpro-card-number" class="form-control validate-rb-credit-card" name="payment_data[card_number]" required="true" autocomplete="off"/>
		        </div>
		...
		<!--					<option value="" selected="selected">YYYY </option>-->
	       ...
	       <div class="form-group clearfix">
			        ...
			        <div class="input-group">
			        	<input type="text" size="4" name="payment_data[card_code]" class="form-control validate-rb-cvc-length" id="rb-processor-paypalpro-cvc-number" data-rb-validate='#rb-processor-paypalpro-card-number'  required="true" class="input-small"  autocomplete="off"/>
			 ...
			 <div class="form-group">
		          ...
		          <div>
		          		<input type="text" class="form-control required " name="payment_data[first_name]" id="rb-processor-paypalpro-first_name" value=""></input>
		          </div>
	         ...
	         <div class="form-group">
		          ...
		          <div >
		          		<input type="text" class="form-control required " name="payment_data[last_name]" id="rb-processor-paypalpro-last_name" value=""></input>
		          </div>
			...
			<div class="form-group">
		            ...
		            <div >	
		          		<input type="email" class="form-control required validate-email" name="payment_data[email]" id="rb-processor-paypalpro-email" value=""></input>
		            </div>
	        ...
	        <div class="form-group">
		          ...
		          <div >
		          		<input type="text" class="form-control required " name="payment_data[mobile]" id="rb-processor-paypalpro-mobile" value=""></input>
		          </div>
	        ...
	        <div class="form-group">
		            ...
		            <div >
		          		...
		          		<textarea  class="form-control required " name="payment_data[address]" id="rb-processor-paypalpro-address" ></textarea>
		          </div>
	        ...
	        <div class="form-group">
		            ...
		            <div >
		  				<?php echo PaycartHtmlCountry::getList("payment_data[country]", '', "rb-processor-paypalpro-country", array('class' => 'form-control required')); ?>
		            </div>
	         ...
	         <div class="form-group">
		            ...
		            <div >
		          		<input type="text" class="form-control required " name="payment_data[state]" id="rb-processor-paypalpro-state" value=""></input>
		            </div>
	           ...
	           <div class="form-group">
			          ...
			          <div >
			          	<input type="text" class="form-control required " name="payment_data[city]" id="rb-processor-paypalpro-city" value=""></input>
			          </div>
	          ...
	          <div class="form-group">
		          ...
		          <div >    
		          	<input type="text" class="form-control required " name="payment_data[zip]" id="rb-processor-paypalpro-zip" value=""></input>
		          </div>
