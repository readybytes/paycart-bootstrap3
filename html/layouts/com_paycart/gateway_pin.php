...
<div class="well clearfix">
		...
		<span class="payment-errors hide"></span>
		 ...
		 <div class="form-group">
		        ...
		        <div>
		        	<input type="text"  size="20" id="rb-processor-pin-card-number" class="form-control validate-rb-credit-card" name="payment_data[card_number]" required="true" autocomplete="off" value=""/>
		        </div>
       ...
       <div class="form-group clearfix">
		        ...
		        <div>
		        	<input type="text" size="4" name="payment_data[card_code]" class="form-control input-small validate-rb-cvc-length" id="rb-processor-pin-cvc-number" data-rb-validate='#rb-processor-pin-card-number'  required="true" class="input-small"  autocomplete="off" value=""/>
		            <span class="add-on">
		            	<?php 
		 ...
		 <div class="form-group">
	          ...
	          <div>
	          		<input type="text" class="form-control required" name="payment_data[card_name]" id="rb-processor-pin-card-name" value="" placeHolder="<?php echo JText::_('PLG_RB_ECOMMERCEPROCESSOR_PIN_CARD_NAME_HELP')?>"></input>
	          </div>
		...
		<div class="form-group">
	            ...
	            <div>
	          		...
	          		<textarea  class="form-control required " name="payment_data[address]" id="rb-processor-pin-address" value=""></textarea>
	          </div>
        ...
        <div class="form-group">
	            ...
	            <div>
	  				<?php echo Rb_EcommerceHtmlCountries::getList("payment_data[country]", '', "rb-processor-pin-country", array('class' => 'form-control required'),'isocode2'); ?>
	            </div>
         ...
         <div class="form-group">
	            ...
	            <div>
	          		<input type="text" class="form-control required " name="payment_data[state]" id="rb-processor-pin-state" value=""></input>
	            </div>
         ...
         <div class="form-group">
	          ...
	          <div>
	          	<input type="text" class="form-control required " name="payment_data[city]" id="rb-processor-pin-city" value=""></input>
	          </div>
        ...
        <div class="form-group">
	            ...
	            <div>
	          		<input type="text" class="form-control required " name="payment_data[zip]" id="rb-processor-pin-zip" value=""></input>
	            </div>
