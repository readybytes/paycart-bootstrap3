...
<div class="well clearfix">
        ...
        <div class="form-group">
	          ...
	          <div>
	           		 <input type="text" class="form-control required "  id="rb-processor-ebs-name" name="name" value=""></input>
	          </div>
        ...
        <div class="form-group">
	          ...
	          <div>
	           	 <input type="text" class="form-control required "  id="rb-processor-ebs-address" name="address" value=""></input>
	          </div>
         ...
         <div class="form-group">
	          ...
	          <div>
	          	  <input type="text" class="form-control required "  id="rb-processor-ebs-city" name="city" value=""></input>
	          </div>
         ...
         <div class="form-group">
	          ...
	          <div>
	          	  <input type="text" class="form-control required "  id="rb-processor-ebs-state" name="state" value=""></input>
	          </div>
             ...
             <div class="form-group" >
             	<div class="control-label">
		          ...
		          <div>
		  			<?php echo Rb_EcommerceHtmlCountries::getList("country", '', "rb-processor-ebs-country", array('class' => 'form-control required')); ?>
		          </div>
         ...
         <div class="form-group">
	          ...
	          <div>
	          	  <input type="text" class="form-control required "  id="rb-processor-ebs-postal_code" name="postal_code" value=""></input>
	          </div>
         ...
         <div class="form-group">
	          ...
	          <div>
	          	  <input type="text" class="form-control required "  id="rb-processor-ebs-phone" name="phone" value=""></input>
	          </div>
         ...
         <div class="form-group">
	          ...
	          <div>
	          	  <input type="email" class="form-control required validate-email"  id="rb-processor-ebs-email" name="email" value=""></input>
	          </div>
	...
	<legend><?php echo JText::_('PLG_RB_ECOMMERCEPROCESSOR_EBS_FORM_EBS_SHIPPING_DETAILS');?></legend>
	 ...
	 <label class="checkbox">
          ...
          <div class="form-group">
	          ...
	          <div>
	           		 <input type="text" class="form-control required "  id="rb-processor-ebs-ship-name" name="ship_name" value=""></input>
	          </div>
        ...
        <div class="form-group">
	          ...
	          <div>
	           	 <input type="text" class="form-control required "  id="rb-processor-ebs-ship-address" name="ship_address" value=""></input>
	          </div>
         ...
         <div class="form-group">
	          ...
	          <div>
	          	  <input type="text" class="form-control required "  id="rb-processor-ebs-ship-city" name="ship_city" value=""></input>
	          </div>
         ...
         <div class="form-group">
	          ...
	          <div>
	          	  <input type="text" class="form-control required "  id="rb-processor-ebs-ship-state" name="ship_state" value=""></input>
	          </div>
         ...
         <div class="form-group">
	          ...
	          <div>
	          	  <input type="text" class="form-control required "  id="rb-processor-ebs-ship-postal_code" name="ship_postal_code" value=""></input>
	          </div>
         ...
         <div class="form-group">
	          ...
	          <div>
	          	  <input type="text" class="form-control required "  id="rb-processor-ebs-ship-phone" name="ship_phone" value=""></input>
	          </div>
