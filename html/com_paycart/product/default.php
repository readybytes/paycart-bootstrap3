				...
				<div class="row clearfix">
                	<div class="col-sm-12 col-md-6">                 
                    	<?php if(!$isExistInCart):?>
                        	<button class="btn btn-block btn-lg btn-primary pc-btn-buynow" onClick='rb.url.redirect("<?php echo PaycartRoute::_('index.php?option=com_paycart&view=cart&task=buy&product_id='.$product->getId()); ?>"); return false;'>
